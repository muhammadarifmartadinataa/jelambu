    ...
    <div id="hero-section" class="max-w-[1200px] mx-auto w-full flex flex-col gap-10 pb-[50px] bg-[url('assets/background/Hero-Banner.png')] bg-center bg-no-repeat bg-cover rounded-[32px] overflow-hidden">
        <nav class="flex justify-between items-center pt-6 px-[50px]">
            ...
            <ul class="flex items-center gap-[30px] text-white">
                ...
                <li>
                    <a href="pricing.html" class="font-semibold">Kabupaten</a>
                </li>
                <li>
                    <a href="" class="font-semibold">Wisata</a>
                </li>
            </ul>
            <div class="flex gap-[10px] items-center">
                <a href="" class="text-white font-semibold rounded-[30px] p-[16px] ring-1 ring-white transition-all duration-300 hover:ring-2 hover:ring-[#FF6129]">
